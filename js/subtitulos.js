...
var elemento5=document.getElementsByClassName("subtitulo");
    ...
    elemento5[0].style.textAlign="center";
    elemento5[1].style.textAlign="center";
    elemento5[2].style.textAlign="center";
    elemento5[0].style.margin="0";
    elemento5[1].style.margin="0";
    elemento5[2].style.margin="0";
